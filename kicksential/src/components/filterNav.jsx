        ...
        <div className="bg-gray-100 flex flex-col w-[250px]">
            <h1 className="flex justify-center text-5xl">Filters</h1>
                ...
                <div className="flex flex-row flex-wrap w-5/6">
                    ...
                    name='green' className="m-5 w-5 h-5 rounded-full bg-green-500"></p>
                    <p 
                    onClick={props.getRed}
                    name='red' className="m-5 w-5 h-5 rounded-full bg-red-500"></p>
                    <p 
                    onClick={props.getYellow}
                    name='yellow' className="m-5 w-5 h-5 rounded-full bg-yellow-500"></p>
                    <p 
                    onClick={props.getBlack}
                    name='black' className="m-5 w-5 h-5 rounded-full bg-black"></p>
                    <p 
                    onClick={props.getWhite}
                    name='white' className="m-5 w-5 h-5 rounded-full bg-white"></p>
                    <p 
                    onClick={props.getBlue}
                    name='blue' className="m-5 w-5 h-5 rounded-full bg-blue-500"></p>
                    
                    <p 
                    onClick={props.getGrey}
                    name='grey' className="m-5 w-5 h-5 rounded-full bg-gray-500"></p>
                    <p 
                    onClick={props.getPink}
                    name='pink' className="m-5 w-5 h-5 rounded-full bg-pink-500"></p>
